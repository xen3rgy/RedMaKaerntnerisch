...
(function () {
  ...
  function applyAdminUI() {
    // Global marker for CSS (layout transitions etc.)
    ...
    const host = document.querySelector('header .header-actions') || document.querySelector('header .flex.items-center.gap-2') || document.querySelector('header');
    ...
    if (isAdmin()) {
      if (!badge) {
        ...
        badge.id = 'adminBadge';
        // Keep the topbar spacing consistent with the other header actions
